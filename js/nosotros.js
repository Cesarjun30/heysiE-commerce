...
document.querySelector('#nosotros').innerHTML = `
  <main>
        ...
        <div class="container">
          ...
          <nav class="mainMenu">
            <menu>
              ...
              <li><a href="partyservice.html">Party-Service <i class="fa-solid fa-caret-down"></i
                ></a>
              </li>
      ...
      <section> <p>SOY LA PAGINA NOSOTROS </p></section>
